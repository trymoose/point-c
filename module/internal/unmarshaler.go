...
// Unmarshaler returns a function that unmarshals Caddyfile configuration into a specific type.
...
func Unmarshaler[T any, TP caddyfileUnmarshaler[T]](name string) func(d *caddyfile.Dispenser, resume any) (any, error) {
	return func(d *caddyfile.Dispenser, resume any) (any, error) {
		...
		// Generic parameters ensure that the pointer of T implements [caddyfile.Unmarshaler].
